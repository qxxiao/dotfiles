...
local options = { 
    ...
    guifont ="Fira Code",                -- font for the gui
    foldmethod = "expr",                    -- folding with treesitter indent, syntax
    foldexpr = "nvim_treesitter#foldexpr()", -- folding with treesitter indent
    foldenable = false,                       -- enable folding 默认打开文件全部折叠
